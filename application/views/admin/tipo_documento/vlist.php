      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
                <a href="<?php echo base_url();?>mantenimiento/ctipo_documento/cadd" class="btn btn-primary "><span class="fa fa-plus"></span>Agregar tipo_documento</a>
                  ...
                  <tbody>
                    <?php if(!empty($tipo_documentoindex)): ?>
                      <?php foreach ($tipo_documentoindex as $atributos): ?>
                        <tr>
                              <td><?php echo $atributos->idtipo_documento; ?></td>
                              ...
                              ?>
                              <?php $data = $atributos->idtipo_documento."*".$atributos->codigo."*".$atributos->nombre."*".$atributos->descripcion; ?>
                              ...
                              <td>
                                <div class="btn-group">
                                  ...
                                  <a href="<?php echo base_url();?>mantenimiento/ctipo_documento/cedit/<?php echo $atributos->idtipo_documento;?>" class="btn btn-warning">
                                  <span class="fas fa-edit"></span>
                                  </a>
                                  <a href="<?php echo base_url();?>mantenimiento/ctipo_documento/cdelete/<?php echo $atributos->idtipo_documento;  ?>" class="btn btn-danger btn-remove">
