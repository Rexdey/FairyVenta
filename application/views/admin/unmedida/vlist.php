      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
                <a href="<?php echo base_url();?>mantenimiento/cunmedida/cadd" class="btn btn-primary "><span class="fa fa-plus"></span>Agregar unmedida</a>
                  ...
                  <tbody>
                    <?php if(!empty($unmedidaindex)): ?>
                      <?php foreach ($unmedidaindex as $atributos): ?>
                        <tr>
                              <td><?php echo $atributos->idunmedida; ?></td>
                              ...
                              ?>
                              <?php $data = $atributos->idunmedida."*".$atributos->codigo."*".$atributos->nombre."*".$atributos->descripcion; ?>
                              ...
                              <td>
                                <div class="btn-group">
                                  ...
                                  <a href="<?php echo base_url();?>mantenimiento/cunmedida/cedit/<?php echo $atributos->idunmedida;?>" class="btn btn-warning">
                                  <span class="fas fa-edit"></span>
                                  </a>
                                  <a href="<?php echo base_url();?>mantenimiento/cunmedida/cdelete/<?php echo $atributos->idunmedida;  ?>" class="btn btn-danger btn-remove">
