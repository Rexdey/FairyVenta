      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
                <a href="<?php echo base_url();?>mantenimiento/cmedida/cadd" class="btn btn-primary"><span class="fa fa-plus"></span>Agregar medida</a>
            ...
            <div class="row">
              <div class="col-md-12">
                <table id="example1" class="table table-bordered table-hover" width="100%">
                  ...
                  <tbody>
                    <?php if(!empty($medidaindex)): ?>
                      <?php foreach ($medidaindex as $atributos): ?>
                        <tr>
                              <td><?php echo $atributos->idmedida; ?></td>
                              ...
                              ?>
                              <?php $data = $atributos->idmedida."*".$atributos->codigo."*".$atributos->nombre."*".$atributos->descripcion; ?>
                              ...
                              <td>
                                <div class="btn-group">
                                  ...
                                  <a href="<?php echo base_url();?>mantenimiento/cmedida/cedit/<?php echo $atributos->idmedida;?>" class="btn btn-warning">
                                  <span class="fas fa-edit"></span>
                                  </a>
                                  <a href="<?php echo base_url();?>mantenimiento/cmedida/cdelete/<?php echo $atributos->idmedida;  ?>" class="btn btn-danger btn-remove">
