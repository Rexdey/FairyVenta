        ...
        <div class="card-body" >
          <div class="row">
            <div class="col-md-12">
              ...
              <?php endif; ?>
              <!-- <form role="form" id="quickForm" action="<?php echo base_url();?>mantenimiento/cmedida/cinsert" method="post"> -->
              <form  action="<?php echo base_url();?>mantenimiento/cmedida/cinsert" method="post">
...
<!-- <?php if ($this->uri->segment(2)=='cmedida') {?> -->
