            ...
            <div class="col-md-12">
              ...
              <form action="<?php echo base_url();?>mantenimiento/cproveedor/cupdate" method="POST">
                ...
                <div class="form-group <?php echo !empty(form_error('txtcodigo'))? $valid="is-invalid" :'';?>">
                  ...
                  <input type="text" id="txtcodigo" name="txtcodigo" value="<?php echo !empty(form_error('txtcodigo'))? set_value('txtcodigo') :$proveedoredit->codigo ?>" class="form-control <?php if(form_error('txtcodigo')) : ?>is-invalid<?php endif; ?>" onblur="this.value=this.value.toUpperCase();">
                ...
                <div class="form-group <?php echo !empty(form_error('txtnombre'))? 'has-error' :'';?>">
                  ...
                  <input type="text" id="txtnombre" name="txtnombre" value="<?php echo $proveedoredit->nombre ?>" class="form-control <?php if(form_error('txtnombre')) : ?>is-invalid<?php endif; ?>" onblur="this.value=this.value.toUpperCase();">
                  <?php echo form_error('txtnombre','<span class="help-block" style="color:red">','</span>') ?>
                </div>
                <div class="form-group">
                  <label for="direccion">Dirección</label>
                  <input type="text" id="txtdireccion" name="txtdireccion" value="<?php echo $proveedoredit->direccion ?>" class="form-control <?php if(form_error('txtdireccion')) : ?>is-invalid<?php endif; ?>" onblur="this.value=this.value.toUpperCase();">
                </div>
                <div class="form-group">
                  <label for="telefono">Telefono</label>
                  <input type="text" id="txttelefono" name="txttelefono" value="<?php echo $proveedoredit->telefono ?>" class="form-control <?php if(form_error('txttelefono')) : ?>is-invalid<?php endif; ?>" onblur="this.value=this.value.toUpperCase();">
                </div>
