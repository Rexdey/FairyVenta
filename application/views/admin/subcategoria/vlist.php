      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
                <a href="<?php echo base_url();?>mantenimiento/csubcategoria/cadd" class="btn btn-primary"><span class="fa fa-plus"></span>Agregar subcategoria</a>
            ...
            <div class="row">
              <div class="col-md-12">
                <table id="example1" class="table table-bordered table-hover" width="100%">
                  ...
                  <tbody>
                    <?php if(!empty($subcategoriaindex)): ?>
                      <?php foreach ($subcategoriaindex as $atributos): ?>
                        <tr>
                              <td><?php echo $atributos->idsubcategoria; ?></td>
                              ...
                              ?>
                              <?php $data = $atributos->idsubcategoria."*".$atributos->codigo."*".$atributos->nombre."*".$atributos->descripcion; ?>
                              ...
                              <td>
                                <div class="btn-group">
                                  ...
                                  <a href="<?php echo base_url();?>mantenimiento/csubcategoria/cedit/<?php echo $atributos->idsubcategoria;?>" class="btn btn-warning">
                                  <span class="fas fa-edit"></span>
                                  </a>
                                  <!-- <a href="<?php echo base_url();?>mantenimiento/csubcategoria/cdelete/<?php echo $atributos->idsubcategoria;  ?>" class="btn btn-danger btn-remove"> -->
                                  <button onclick="myModal2(this)" type="button" class="btn btn-danger btn-remove" data-toggle="modal" data-target="#modal-confirmacion" value="<?php echo $atributos->idsubcategoria; ?>">
...
<script type="text/javascript">
  function myModal2($var){
      var boton = $var.value;
      conf="<a href=<?php echo base_url();?>mantenimiento/csubcategoria/cdelete/"+boton+" role='button' class='btn btn-danger'>Eliminar</a><button type='button' class='btn btn-secondary' data-dismiss='modal'>Cancelar</button>";
