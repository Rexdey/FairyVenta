...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url();?>assets/plugins/select2alt/bootstrap-select.min.css">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <span class="dropdown-item dropdown-header">Titulo</span>
          <div class="dropdown-divider"></div>
          <a href="<?php echo base_url();?>clogin/clogout" class="dropdown-item">
             Cerrar Sesion
          </a>
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          Session <i class="far fa-comments"></i>
